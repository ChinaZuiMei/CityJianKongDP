...
function UndergroundTank({ label, level }: { label: string; level: number }) {
  return (
    <div className="workshop-six-underground-tank">
      <img src={undergroundTankImage} alt={label} className="workshop-six-underground-tank__image" draggable="false" />
  ...
  return (
    <>
      ...
      <main className="relative z-10 flex-1 overflow-hidden bg-transparent">
        ...
        />
        <WorkshopSixBody activeRegionIndex={activeRegionIndex} onActiveRegionIndexChange={setActiveRegionIndex} />
      </main>
    </>
  );
}
