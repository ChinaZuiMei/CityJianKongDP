...
interface WorkshopEightSidePanelProps {
    data: ScadaData;
    title?: string;
    subtitle?: string;
    position?: 'left' | 'right';
...
const tankMetrics: TankMetric[] = [
    {
        ...
        max: 3.6,
        unit: 'm',
        color: ['rgba(25, 208, 255, 0.18)', 'rgba(53, 211, 255, 1)']
    },
    {
        id: 'hcl_tank2_level',
        label: '2# 盐酸罐',
        max: 3.6,
        unit: 'm',
        color: ['rgba(33, 149, 255, 0.16)', 'rgba(65, 159, 255, 1)']
    },
    {
        id: 'hcl_tank3_level',
        label: '3# 盐酸罐',
        max: 3.6,
        unit: 'm',
        color: ['rgba(58, 119, 255, 0.14)', 'rgba(108, 193, 255, 1)']
    },
    {
        id: 'h2so4_tank1_level',
        label: '1# 硫酸罐',
        max: 6.2,
        unit: 'm',
        color: ['rgba(31, 239, 216, 0.14)', 'rgba(76, 238, 221, 1)']
    },
];
...
export const WorkshopEightSidePanel: React.FC<WorkshopEightSidePanelProps> = ({
                                                                                  data,
                                                                                  title = '罐区可视化面板',
    ...
    return (
        <aside
            className={`w8-side-panel w8-side-panel--${position}${embedded ? ' w8-side-panel--embedded' : ''}`}
            style={{
            ...
            <section className="sci-panel tank-panel-main">
                <div className="sci-panel-body">
                    {mode === 'temperature' ? (
                        ...
                        <div
                            className={externalVisible ? 'external-panel-content' : 'external-panel-content external-panel-content--hidden'}>
                            <div className="tank-panel-chart-meta">
                        ...
                        <>
                            ...
                            <div className="loading-panel-status">
                                <div className="loading-panel-truck-wrap">
                                    ...
                                    >
                                        <img src={loadingTruckImage} alt="装车罐车" className="loading-panel-truck"
                                             draggable="false"/>
                                    </div>
                                    <div
                                ...
                                <div
                                    className={data.loading_instant > 0 ? 'data-glow-emerald loading-panel-state' : 'data-glow loading-panel-state'}>
                ...
                <span>
                  {activeFlowItem?.title ?? (hideFlowName ? '' : effectiveFlowVariant === 'acid' ? '盐酸硫酸流量' : '东氟废水流量')}
                            ...
                            <div
                                className={flowVisible ? 'external-panel-content' : 'external-panel-content external-panel-content--hidden'}>
