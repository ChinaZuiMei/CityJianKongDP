...
import {WorkshopFiveLeftPanels, WorkshopFiveRightPanels} from './workshop-five';
...
export function WorkshopFiveView({
    ...
    return (
        <>
            ...
            <button
                type="button"
                className={leftPanelCollapsed ? 'w5-side-panel-toggle w5-side-panel-toggle--left w5-side-panel-toggle--collapsed' : 'w5-side-panel-toggle w5-side-panel-toggle--left'}
            ...
            <div
                className={leftPanelCollapsed ? 'w5-side-panel-column w5-side-panel-column--left w5-side-panel-column--collapsed-left' : 'w5-side-panel-column w5-side-panel-column--left'}>
                <WorkshopFiveLeftPanels data={scadaData}/>
            </div>

            <button
                type="button"
                className={rightPanelCollapsed ? 'w5-side-panel-toggle w5-side-panel-toggle--right w5-side-panel-toggle--collapsed' : 'w5-side-panel-toggle w5-side-panel-toggle--right'}
            ...
            <div
                className={rightPanelCollapsed ? 'w5-side-panel-column w5-side-panel-column--right w5-side-panel-column--collapsed-right' : 'w5-side-panel-column w5-side-panel-column--right'}>
                <WorkshopFiveRightPanels data={scadaData}/>
            </div>
