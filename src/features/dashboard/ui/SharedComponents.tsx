...
export const Tank = ({
  ...
  const imageTankSizeClass = variant === 'reactor' ? 'h-[14rem] w-[11.5rem]' : 'h-[13.5rem] w-[8.5rem]';
    ...
    <div className="flex flex-col items-center gap-3">
      {isImageTank ? (
        <div className={cn("relative transition-all", imageTankSizeClass)}>
          ...
          <div className={cn("absolute inset-x-0 z-20 flex justify-center", variant === 'reactor' ? 'bottom-[2.25rem]' : 'bottom-[3.8rem]')}>
