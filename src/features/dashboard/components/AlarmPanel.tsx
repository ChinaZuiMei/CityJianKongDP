...
export const AlarmPanel = ({alarms, alarmData, isOpen, onClose}: {
    alarms: Alarm[],
    alarmData: AlarmData,
    isOpen: boolean,
    onClose: () => void
    ...
    return (
        <>
            ...
            <span
                className="rounded-full border border-red-400/70 bg-[#2b0e14] px-2.5 py-1 text-xs font-black text-red-100">
              {activeAlarmCount}
            </span>
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div
                                                className="break-words text-base leading-tight font-medium text-slate-100">
                                        ...
                                        <div
                                            className="w-2 h-2 rounded-full bg-red-600 animate-pulse flex-shrink-0 mt-2"/>
                                    </div>
                                </motion.div>
                            );
                        })}
