...
export const ScrollDashboard = ({
    ...
    return (
        <div
            className={`dashboard-scroll-shell flex h-full w-full min-h-0 min-w-0 items-center justify-center overflow-y-auto overflow-x-hidden ${outerClassName}`}>
            <div
            ...
            >
                ...
                >
                    <div
                        className={detachedRegionBody ? 'mx-auto h-[760px] w-[1040px] max-w-full overflow-visible' : 'mx-auto h-[760px] w-[1040px] max-w-full overflow-hidden'}>
                        <div className="relative mx-auto h-full w-full">
                                ...
                                >
                                  ...
                                  <span className="text-xs font-black tracking-[0.16em]">
                                    {isPlaceholder ? 'ALARM SLOT' : alarm.level}
                                                                ...
                                                                <div
                                                                    className={isPlaceholder ? 'text-[1.6rem] font-black tracking-[0.02em] text-red-100/68' : 'text-[1.6rem] font-black tracking-[0.02em] text-red-50'}>
                                                                    {alarm.title}
                                                                </div>
                                                                <div
                                                                    className="text-[13px] font-semibold tracking-[0.08em] text-red-100/72">
                                                                    {alarm.label}
                                                                </div>
                                                            </div>
                                                        );
                                                ...
                                                {!hideRegionHeader ? (
                                                    <div
                                                        className="pointer-events-none mt-7 flex items-center justify-center gap-4 text-base font-black tracking-[0.24em] text-sky-100/62">
                            ...
                            {!hideRegionBody ? (
                                <div
                                    className={detachedRegionBody ? 'absolute left-1/2 top-[49%] z-10 w-[1040px] max-w-full -translate-x-1/2 overflow-visible' : 'absolute inset-x-0 bottom-0 top-[282px] overflow-hidden'}>
                                    <div
                                        className={detachedRegionBody ? 'h-[520px] overflow-hidden' : 'h-full overflow-hidden'}>
                                        <div
                                        ...
                                        >
                                            {bodyRegions.map((region) => (
                                                <div key={region.id} className="flex min-w-full flex-col">
                                                    <div
                                                        className={`flex h-full overflow-visible ${region.bodyClassName}`}>
